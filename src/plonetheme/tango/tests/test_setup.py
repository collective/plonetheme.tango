...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        """Test if plonetheme.tango is installed with portal_quickinstaller."""
        self.assertTrue(self.installer.isProductInstalled('plonetheme.tango'))

    def test_browserlayer(self):
        """Test that IPlonethemeTangoLayer is registered."""
        from plonetheme.tango.interfaces import IPlonethemeTangoLayer
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.isProductInstalled('plonetheme.tango'))
